...
data_extracted_from_text <- read_csv("../../../data/extracted/foody 2013 thesis experiment 10/summary statistics extracted from text.csv")

data_extracted_from_plots <- 
  bind_rows(
    read_csv("../../../data/extracted/foody 2013 thesis experiment 10/summary stats extracted from plots/discomfort.csv",
           col_names = FALSE,
           show_col_types = FALSE) |>
      mutate(outcome = "discomfort"),
    read_csv("../../../data/extracted/foody 2013 thesis experiment 10/summary stats extracted from plots/anxiety.csv",
           col_names = FALSE,
           show_col_types = FALSE) |>
      mutate(outcome = "anxiety"),
    read_csv("../../../data/extracted/foody 2013 thesis experiment 10/summary stats extracted from plots/stress.csv",
           col_names = FALSE,
           show_col_types = FALSE) |>
...
- both methods of calculating means agree to within .25% on the scale.
...
dir.create("../../../data/extracted/foody 2013 thesis experiment 10/")

write_csv(data_processed, "../../../data/extracted/foody 2013 thesis experiment 10/data_extracted_all.csv")
...
data_processed |>
  ...
  select(outcome, 
         ...
         sd_assuming_ci, 
         sd_assuming_sem) |>
  write_csv("../../../data/processed/foody 2013 thesis experiment 10/data_processed.csv")
